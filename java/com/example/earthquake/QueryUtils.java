...
public final class QueryUtils {
    ...
    public static void setSampleJsonResponse(String json)
    {
    ...
    public static ArrayList<Row> extractEarthquakes() {

        ArrayList<Row> earthquakes = new ArrayList<>();
        ...
        try {
                ...
                {
                    JSONObject curr=features.getJSONObject(i);
                    JSONObject properties=curr.getJSONObject("properties");
                    float m=(float) properties.optDouble("mag");
                    String loc= properties.getString("place");
                    long timeInUnix=properties.optLong("time");
                    Date dateObject=new Date(timeInUnix);
                    SimpleDateFormat sdf=new SimpleDateFormat("dd MMM YYYY");
                    SimpleDateFormat stf=new SimpleDateFormat("h:mm a");
                    String date= sdf.format(dateObject);
                    String time= stf.format(dateObject);
                    String url=properties.getString("url");
                    earthquakes.add(new Row(m,loc,date,time,url));
                }
